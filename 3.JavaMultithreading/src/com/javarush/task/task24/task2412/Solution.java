...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (!name1.equals(name2)) return ((String)stock1.get("name")).compareTo((String)stock2.get("name"));
                else if (date1 != date2) return date2.compareTo(date1);
                else return (int) (profit1) - (int) (profit2);
            }
        });
    }
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Google Inc.", "sdfsd", 516.2, 512.6));

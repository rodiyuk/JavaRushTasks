...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        Optional<Car> moreExpensiveCar = getCheaperCar(tesla);
        moreExpensiveCar.ifPresent(System.out::println);

        Optional<Car> mostExpensiveCar = moreExpensiveCar.flatMap(car -> getCheapestCar(bmw, car));
        mostExpensiveCar.ifPresent(System.out::println);
    }

    public static Optional<Car> getCheaperCar(Stream<Car> cars) {
        //напишите тут ваш код
        return cars.min((c1, c2) -> c1.getPrice() - c2.getPrice());
    }

    public static Optional<Car> getCheapestCar(Stream<Car> cars, Car mostExpensiveCar) {
        //напишите тут ваш код
